        ...
        <div className="home">
            {
                data.map(item=>{
                    ...
                    <div className="card home-card" key={item._id}>
                        <h5 style={{padding:"5px"}}><Link to={item.postedBy._id===state._id?"/profile/":"/profile/"+item.postedBy._id}><img src={item.postedBy.pic} style={{ float:"left", width:"25px", height:"25px", borderRadius:"80px", margin:" 2px 10px"}}/>
                        ...
                        <div className="card-content">
                            ...
                            <p>{item.body}</p>
                            {
                                item.comments.map(rec=>{
                                    return(
                                        <h6 key={rec._id}><span style={{fontWeight:"500"}}><Link to={item.postedBy._id===state._id?"/profile/":"/profile/"+rec.postedBy._id}><img src={rec.postedBy.pic} style={{ float:"left", width:"25px", height:"25px", borderRadius:"80px", margin:" 2px 10px"}}/>{rec.postedBy.name}</Link></span> {rec.text} 
                                        {/* {
